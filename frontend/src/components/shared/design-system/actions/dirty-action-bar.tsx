...
export function DirtyActionBar({
  ...
  return (
    ...
    >
      <div className="pointer-events-auto mx-auto flex w-full max-w-5xl items-center justify-between gap-4 rounded-xl bg-card px-4 py-3 smooth-shadow-ring-lg shadow-black smooth-ring-neutral-300/30">
