export const designSystemColorTokens = [
  ...
  { name: "sidebar-muted-foreground", value: "var(--sidebar-muted-foreground)" },
  ...
  { name: "table-header-background", value: "var(--table-header)" },
  { name: "table-header-foreground", value: "var(--table-header-foreground)" },
] as const;
