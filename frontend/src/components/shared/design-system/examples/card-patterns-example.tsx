...
export function CardPatternsExample() {
  return (
    <div className="grid gap-4 md:grid-cols-2">
      <Card className="gap-0 overflow-hidden rounded-[12px] bg-card p-0">
      ...
      <Card className="gap-0 overflow-hidden rounded-[12px] bg-card/80 p-0 backdrop-blur-lg transition-colors duration-300">
        <CardHeader className="px-4 py-6 !pb-6">
          <CardTitle className="text-sm font-medium normal-case text-foreground">
            Frosted Glass Card
          </CardTitle>
      ...
      <Card className="relative gap-0 overflow-hidden rounded-[12px] bg-card p-0">
        <CardHeader className="px-4 py-6 !pb-6">
          <CardTitle className="text-sm font-medium normal-case text-foreground">
            Table Card
          </CardTitle>
