...
const DateTickerCompact = memo(function DateTickerCompact({
  ...
  return (
    <div className="overflow-hidden rounded-full bg-zinc-900 px-4 py-1 text-white smooth-shadow-ring-xs shadow-black smooth-ring-neutral-300/30 dark:bg-zinc-100 dark:text-zinc-900">
