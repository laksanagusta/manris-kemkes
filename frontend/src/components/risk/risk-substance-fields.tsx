    ...
    (items: MitigationItem[]) => {
      updateRiskSubstanceField(
        ...
        items.map((item) => ({
          ...
          frequency: item.frequency as RiskMitigation["frequency"],
          recurringInterval: item.recurringInterval as RiskMitigation["recurringInterval"],
          reportDay: item.reportDay,
