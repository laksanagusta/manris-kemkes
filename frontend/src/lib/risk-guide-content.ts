...
export const riskGuideContent: RiskGuideContent = {
  hero: {
    ...
    title: "Panduan Risiko di MANRIS",
    description:
      "Pahami alur risiko di MANRIS — dari pendaftaran, persetujuan, hingga pemantauan berkala.",
    summary:
  ...
  steps: [
    {
      ...
      actions: [
        "Buka menu Daftar Risiko → klik 'Risiko Baru'.",
        ...
        "Pilih Evaluasi: opsi penanganan (Kurangi/Pantau/Alihkan/Terima), prioritas, appetite.",
    ...
    },
    {
      ...
      description:
        "Setelah draft lengkap, klik 'Finalisasi'. Sistem langsung mengubah status menjadi 'Disetujui' — tanpa perlu reviewer atau approver karena alur persetujuan disederhanakan. Risiko langsung aktif.",
      actions: [
        ...
        "Risiko terkunci dan tidak bisa diedit langsung — harus melalui siklus pemantauan.",
      ],
      status: "approved",
    ...
    },
    {
      ...
      description:
        "Setelah draft lengkap, klik 'Finalisasi'. Sistem langsung menyetujui dan mengaktifkan versi baru. Versi sebelumnya diarsipkan. Pemantauan一轮 selesai — siap memulai一轮 berikutnya.",
      actions: [
        ...
        "Siklus pemantauan selesai. Mulai一轮 baru bila perlu.",
      ],
      status: "approved",
      statusLabel: "Disetujui",
    },
    ...
    items: [
      {
        ...
        answer:
          "Siklus pemantauan mengikuti periode organisasi, misalnya setiap semester (H1 dan H2). Tanggal review berikutnya ditentukan saat mengisi bagian Target pada formulir risiko.",
      },
      {
        question: "Kenapa tidak ada langkah 'Ajukan Review'?",
        answer:
          "Karena alur persetujuan disederhanakan — langsung dari Draft ke Disetujui tanpa proses review. Ini dirancang agar lebih efisien.",
      },
      {
        question: "Apakah risiko bisa dipantau lebih dari sekali dalam satu siklus?",
        answer:
      ...
      },
      {
        ...
        answer:
          "Risiko dikunci untuk menjaga integritas data. Perubahan只能在 pemantauan一轮中进行，以确保 setiap版本的更改都有记录.",
      },
    ],
  },
};
