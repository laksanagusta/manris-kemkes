...
export function TopRisksPanel({
  ...
  return (
    <StandardCard
      ...
      className={cn("rounded-lg xl:h-full xl:min-h-[377px]", className)}
      ...
      {loading ? (
        ...
        <div className="border-t border-border/60 xl:flex xl:flex-1 xl:flex-col">
          <div
            ...
            className="grid min-h-10 w-full grid-cols-[1fr_1fr_1fr_1fr] items-center gap-x-3 border-b border-border/60 bg-card px-6 py-1.5 text-[13px] font-medium capitalize tracking-[0.02em] text-secondary-foreground sm:grid-cols-[5fr_7fr_7fr_10fr_5fr]"
          >
            <span>Kode</span>
