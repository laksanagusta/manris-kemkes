...
func TestBulkRiskSpreadsheetUseCase_Preview_ResolvesOrganizationByName(t *testing.T) {
	...
	headers := []string{"Risiko", "Deskripsi", "Sebab", "Sumber Risiko", "C/UC", "Dampak", "P", "D", "Bobot", "Prioritas Risiko", "Selera Risiko", "Pilihan Penanganan Risiko", "RPR Uraian", "PIC RPR", "Jadwal Pelaksanaan", "Target P", "Target D", "Target Bobot", "Unit Kerja"}
	row := []string{"Risiko A", "Deskripsi A", "Sebab A", "Internal", "C", "Dampak A", "2", "2", "1.2", "4", "Dalam batas", "Mitigasi Risiko", "Aksi", "PIC", "Feb 2026", "1", "1", "1.0", "Inspektorat Utama"}
...
func TestBulkRiskSpreadsheetUseCase_Preview_UsesUploaderOrganizationForUnitRole(t *testing.T) {
	...
	headers := []string{"Risiko", "Deskripsi", "C/UC", "P", "D", "Target P", "Target D", "Target Bobot"}
...
func TestBulkRiskSpreadsheetUseCase_Template_ReturnsWorkbook(t *testing.T) {
